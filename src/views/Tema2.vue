...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    #t_2_1.titulo-segundo(data-aos="flip-up")
      .h4 2.1 Modelo Aristotélico y el paradigma

    p.mb-5(data-aos="slide-right") Ambos modelos se pueden contemplar como un mismo tipo de estructura dramática, teniendo en cuenta que tanto el modelo estudiado por el filósofo Aristóteles en su libro “La Poética”, como “El Paradigma” planteado por Syd Field, se basan en la narración de una historia en 3 actos principales: presentación (acto I) , confrontación (acto II) y resolución del conflicto principal (acto III); sin embargo, “El Paradigma” podría entenderse como una extensión del modelo aristotélico, dado que los actos están divididos por puntos argumentales o plot points, los cuales son acontecimientos que cambian radicalmente el sentido de la acción (Baiz, s.f.).

    figure.mb-5(data-aos="flip-up")
      img.img-a(src='@/assets/curso/tema_2/img_1.png', alt='')
    ...
    ImagenInfografica.mb-5(data-aos="flip-up")
      template(v-slot:imagen)
        figure
          img.img-a(src='@/assets/curso/tema_2/img_2.svg', alt='Texto que describa la imagen')

      .tarjeta.color-acento-botones.p-3(x="48%" y="27%")
      ...
      .tarjeta.color-acento-botones.p-3(x="54%" y="30%")
      ...
      .tarjeta.color-acento-botones.p-3(x="59%" y="37%")
      ...
      .tarjeta.color-acento-botones.p-3(x="61%" y="47%")
      ...
      .tarjeta.color-acento-botones.p-3(x="59%" y="56%")
      ...
      .tarjeta.color-acento-botones.p-3(x="54%" y="63%")
      ...
      .tarjeta.color-acento-botones.p-3(x="48%" y="66%")
      ...
      .tarjeta.color-acento-botones.p-3(x="42%" y="63%")
      ...
      .tarjeta.color-acento-botones.p-3(x="38%" y="56%")
      ...
      .tarjeta.color-acento-botones.p-3(x="36%" y="47%")
      ...
      .tarjeta.color-acento-botones.p-3(x="38%" y="37%")
      ...
      .tarjeta.color-acento-botones.p-3(x="42%" y="30%")
